...
public class DynamoDBLocalFixture {
    ...
    private static void insertDate(AmazonDynamoDB dynamodb) {
    	   DynamoDB dynamoDBlive = new DynamoDB(dynamodb);
           
    	   Table table = dynamoDBlive.getTable("Image2");
    	             
    	   Item item = new Item()
    	             	    .withPrimaryKey("Id", "poonam")
    	             	    .withString("Title", "Bicycle 123")
    	             	    .withString("Description", "123 description")
    	             	    .withNumber("Date", new Date().getTime());
